...
- Do not use markdown formatting. No asterisks for bold or italic, no # for headings. Plain text only.
  ...
  return (
    <div style={s.app}>
      ...
      <div style={s.disclaimer}>
        <span style={s.disclaimerText}>⚠ The responses of this agent are generated by AI. AI can make mistakes and derives its knowledge and conclusions independently from the source material. Always refer to the original document to verify accuracy.</span>
      </div>
...
const s = {
  ...
  disclaimer: { flexShrink: 0, background: "rgba(251,146,60,0.08)", borderBottom: "1px solid rgba(251,146,60,0.2)", padding: "8px 18px", display: "flex", alignItems: "center", justifyContent: "center" },
  disclaimerText: { fontSize: 12, color: "#fb923c", lineHeight: 1.5, maxWidth: 900, textAlign: "center" },
